...
const Hero = () => {  return (
    <div className="self-stretch h-screen bg-gradient-to-b bg-cover bg-[#00000042] flex-col justify-center items-center gap-10 flex relative overflow-hidden px-4 md:px-8 lg:px-16">
        ...
        />
        <div className="w-full max-w-md p-6 bg-[#00000022] rounded-sm backdrop-blur-md flex-col justify-center items-center text-center gap-3 flex md:max-w-lg lg:max-w-3xl">
            ...
            <div className="self-stretch text-[#E4FFEF] text-lg md:text-xl lg:text-2xl font-normal font-['Manrope']">Belajar pertanian digital, organik, hingga pemasaran hasil panen dalam satu platform.</div>            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
