  ...
  return (
    <div className="self-stretch px-8 md:px-20 py-16 md:py-[120px] bg-[#0F5028] flex-col justify-start items-center gap-10 flex text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-5 w-full max-w-md">
            <div data-color="Primary" data-kind="Primary" data-round="Squire" data-state="Default" className="w-full sm:w-[197px] h-11 px-7 py-3 bg-white rounded-sm justify-center items-center gap-2.5 flex">
                <div className="text-center text-[#0F5028] text-base font-medium font-['Manrope'] leading-6">Belajar Sekarang</div>
            </div>
            <div data-color="Secondary" data-kind="Secondary" data-round="Squire" data-state="Default" className="w-full sm:w-[196px] h-11 px-7 py-3 rounded-sm outline-1 outline-offset-[-1px] outline-white justify-center items-center gap-2.5 flex">
